...
1. **Bootstrap**: Scan `JAO/sessions/` for `@api_auditor`. Mark `[STATUS: IN_PROGRESS]`.
2. **Execute**: Audit API Handshakes and Contracts.
3. **Log**: Save results to `JAO/sessions/[ID]/inbox/JAO-[ID]-C_AUDIT_API.md`.
