...
1. **Bootstrap**: Scan `JAO/sessions/` for `@admin_auditor`. Mark `[STATUS: IN_PROGRESS]`.
2. **Execute**: Audit Admin-level dashboard and core controls.
3. **Log**: Save results to `JAO/sessions/[ID]/inbox/JAO-[ID]-C_AUDIT_ADMIN.md`.
