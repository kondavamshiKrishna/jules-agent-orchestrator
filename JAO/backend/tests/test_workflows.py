...
@async_test
async def test_run_workflow_not_initialized(mock_create_task, mock_run_loop, mock_check_board, mock_get_db_pool):
    mock_check_board.return_value = (False, None)
    ...
    mock_check_board.assert_called_once_with("repo123")
...
@patch("app.routes.workflows.asyncio.create_task")
@async_test
async def test_run_workflow_initialized_with_task(mock_create_task, mock_run_loop, mock_check_board, mock_get_db_pool):
    mock_check_board.return_value = (True, {"next_agent": "priya_promptcraft", "prompt": "Test prompt", "mode": "Autonomous"})
...
@patch("app.routes.workflows.asyncio.create_task")
@async_test
async def test_run_workflow_initialized_no_task(mock_create_task, mock_run_loop, mock_check_board, mock_get_db_pool):
    mock_check_board.return_value = (True, None)
